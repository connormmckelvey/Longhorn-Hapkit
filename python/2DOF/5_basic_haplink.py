# Basic Haplink Implementation for 2DOF Haptic Device
...
def main():
    ...
    link = Haplink(port, baudrate=115200)
    ...
    while True:
        ...
        # Send parameter packet to the board (run updates a few times to flush the serial buffer)
        for _ in range(10):
            link.update()
